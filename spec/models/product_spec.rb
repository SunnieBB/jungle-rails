...
RSpec.describe Product, type: :model do
  let(:category) {Category.new(:name => 'games')}
  subject {described_class.new(name: 'OverWatch', price: 80, quantity: 8, category: category)}

  describe 'Validations' do

    it 'saves successfully when all four fields are set to category' do
      subject.valid?
